...
/**
 * Example to demonstrate how to use the reasoner for queries related to individuals. Exact same functionality is shown
 * for both Jena and OWL-API interfaces.
 * 
 * @author Evren Sirin
 */
public class IndividualsExample {
	...
	public static void runWithOWLAPI() throws OWLException {
		...
		PelletReasoner reasoner = com.clarkparsia.pellet.owlapiv3.PelletReasonerFactory.getInstance().createReasoner(
				ontology);

		// create property and resources to query the reasoner
		OWLClass Person = factory.getOWLClass(IRI.create("http://xmlns.com/foaf/0.1/Person"));
		OWLObjectProperty workHomepage = factory.getOWLObjectProperty(IRI
				.create("http://xmlns.com/foaf/0.1/workInfoHomepage"));
