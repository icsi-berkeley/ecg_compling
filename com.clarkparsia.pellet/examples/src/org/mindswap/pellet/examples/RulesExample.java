...
/**
 * An example program that tests the DL-safe rules example from Table 3 in the paper: B. Motik, U. Sattler, R. Studer.
 * Query Answering for OWL-DL with Rules. Proc. of the 3rd International Semantic Web Conference (ISWC 2004), Hiroshima,
 * Japan, November, 2004, pp. 549-563
 * 
 * @author Evren Sirin
 */
...
//		String ont = "http://owldl.com/ontologies/dl-safe.owl";
		String ont = "http://www.icsi.berkeley.edu/~lucag/ontologies/dl-safe.owl";
