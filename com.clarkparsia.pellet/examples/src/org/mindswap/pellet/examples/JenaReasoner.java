...
/**
 * An example to show how to use PelletReasoner as a Jena reasoner. The reasoner can be directly attached to a plain RDF
 * <code>Model</code> or attached to an <code>OntModel</code>. This program shows how to do both of these operations and
