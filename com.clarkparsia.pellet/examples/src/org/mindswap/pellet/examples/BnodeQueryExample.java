...
/**
 * Bnodes used in a SPARQL query are treated as variables but different from ordinary SPARQL variables they are not
 * required to be bound to existing individuals. This means a bnode in the query can be matched with an individual whose
 * existence is inferred from a someValues or a minCardinality restriction.
 * 
 * @author Evren Sirin
 */
public class BnodeQueryExample {
	public static void main(String[] args) throws Exception {
		...
		printQueryResults("Running first query with PelletQueryEngine...",
		...
		printQueryResults("Running second query with PelletQueryEngine...",
		...
		printQueryResults("Running first query with standard Jena QueryEngine...",
