...
public class ModularityExample {
	...
	private void run() throws Exception {
		...
		System.out.println("The ontology contains " + ontology.getLogicalAxiomCount() + " axioms, "
		...
		Set<OWLAxiom> moduleAxioms = ModularityUtils.extractModule(ontology, signature, moduleType);
		...
		System.out.println("The module contains " + moduleOnt.getLogicalAxiomCount() + " axioms, "
