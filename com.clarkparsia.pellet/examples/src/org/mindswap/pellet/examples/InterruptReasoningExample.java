 ...
 * </p>
 * <p>
 * Description: an example program that shows how different reasoning services provided by Pellet can be interrupted
 * based on a user-defined timeout without affecting subsequent query results. The program defines some constant values
 * for timeout definitions to demonstrate various different things but results may vary on different computers based on
 * CPU speed, available memory, etc.
 * </p>
 * <p>
