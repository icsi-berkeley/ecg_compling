...
public class OWL {
	...
	public static OWLAnnotationAssertionAxiom annotation(OWLEntity entity, IRI annotationIRI, OWLLiteral constant) {
		return factory.getOWLAnnotationAssertionAxiom(factory.getOWLAnnotationProperty(annotationIRI), entity.getIRI(),
				constant);
	}
	...
	public static OWLAnnotationAssertionAxiom annotation(OWLEntity entity, IRI annotationIRI, OWLIndividual individual) {
		if (individual.isAnonymous())
			...
			return factory.getOWLAnnotationAssertionAxiom(entity.getIRI(), factory.getOWLAnnotation(
					factory.getOWLAnnotationProperty(annotationIRI), individual.asOWLNamedIndividual().getIRI()));
	}
	...
	public static OWLAnnotationAssertionAxiom comment(OWLEntity entity, String comment) {
		return factory.getOWLAnnotationAssertionAxiom(
				entity.getIRI(),
				factory.getOWLAnnotation(factory.getOWLAnnotationProperty(OWLRDFVocabulary.RDFS_COMMENT.getIRI()),
	 ...
	 * @return An <code>OWLLiteral</code> whose literal is the lexical value of the integer, and whose data type is
	 *         xsd:boolean.
	 */
	...
	public static OWLDisjointObjectPropertiesAxiom disjointProperties(OWLObjectPropertyExpression d1,
			OWLObjectPropertyExpression d2) {
	...
	public static OWLAnnotationAssertionAxiom label(OWLEntity entity, String label) {
		return factory.getOWLAnnotationAssertionAxiom(
				factory.getOWLAnnotationProperty(OWLRDFVocabulary.RDFS_LABEL.getIRI()), entity.getIRI(),
	...
	public static OWLDataPropertyAssertionAxiom propertyAssertion(OWLIndividual subj, OWLDataPropertyExpression pred,
			OWLLiteral obj) {
	...
	public static OWLSubPropertyChainOfAxiom subPropertyOf(OWLObjectPropertyExpression[] subChain,
			OWLObjectPropertyExpression sup) {
