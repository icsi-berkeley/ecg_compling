...
public class PriorityQueue<E> implements Iterator<E>, Serializable, Cloneable {
	private static final long serialVersionUID = -4215457267279143935L;
	...
	public E next() {
		...
		removeFirst();
		if (isEmpty()) {
			worstPriority = Double.POSITIVE_INFINITY;
		}
		return first;
	}
	...
	/**
	 * Gets the priority of the worst-priority element of the queue.
	 */
	public double getWorstPriority() {
		if (size() > 0)
